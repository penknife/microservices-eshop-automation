...
/// </summary>
public sealed class EShopFixture : IAsyncLifetime
{
    // Kafka
...
[CollectionDefinition(nameof(EShopCollection))]
public class EShopCollection : ICollectionFixture<EShopFixture>;
